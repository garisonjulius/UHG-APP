...
def get_recommended_plan_info(uid):
    ...
    response = {
        ...
        'network_preventive_bd': plan_info[8],
        'network_preventive_ad': plan_info[9],
        'network_specialist_bd': plan_info[10],
        'network_specialist_ad': plan_info[11],
        'network_xray_bd': plan_info[12],
        'network_xray_ad': plan_info[13],
        'network_imaging_bd': plan_info[14],
        'network_imaging_ad': plan_info[15],
        'network_blood_bd': plan_info[16],
        'network_blood_ad': plan_info[17],
        'network_generic_bd': plan_info[18],
        'network_generic_ad': plan_info[19],
        'network_brand_bd': plan_info[20],
        'network_brand_ad': plan_info[21],
        'network_npbrand_bd': plan_info[22],
        'network_npbrand_ad': plan_info[23],
        'network_specialty_bd': plan_info[24],
        'network_specialty_ad': plan_info[25],
        'network_hospital_bd': plan_info[26],
        'network_hospital_ad': plan_info[27],
        'network_emergency_bd': plan_info[28],
        'network_emergency_ad': plan_info[29],
        'annual_estimates': plan_info[30]
    }
