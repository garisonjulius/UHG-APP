...
def get_short_description(uid):
    ...
    return(
    {
        'description' : index.query('Can you summarize this description in 30 words?\n' + get_recommended_description(uid), llm_model)
    }
    )